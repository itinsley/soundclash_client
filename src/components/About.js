  ...
  const about = 
    <div className="mx-auto text-center" style={{maxWidth: '56.25rem'}}>
      ...
      <div className="mx-auto text-left">
        ...
        <p><a href="http://en.wikipedia.org/wiki/Sound_clash">Soundclashes</a> originated in West Indian culture where opposing soundsystems or DJ's would compete for supremacy through their sound system and music selection. Winners would be chosen through 'forward surges'.</p>
        <p>At Soundclash you don't need your own sound system and there won't be any forward surges. <a href ='/'>Challenge</a> a friend whose music tastes you admire, discover shed-loads of new music and let the rest of the world watch on as two titans of the virtual decks go head-to-head.</p>
